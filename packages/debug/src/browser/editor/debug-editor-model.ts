...
import { DebugEditorHover } from './debug-editor-hover';
...
export class DebugEditorModel implements Disposable {
    ...
    @inject(DebugEditorHover)
    readonly hover: DebugEditorHover;
