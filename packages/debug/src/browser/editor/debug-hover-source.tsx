...
export class DebugHoverSource extends TreeSource {
    ...
    protected element: ExpressionContainer | undefined;
    *getElements(): IterableIterator<TreeElement> {
    ...
    async evaluate(expression: string): Promise<boolean> {
        this.element = await this.doEvaluate(expression);
        this.fireDidChange();
        return !!this.element;
    }
    protected async doEvaluate(expression: string): Promise<ExpressionContainer | undefined> {
    ...
    protected async findVariable(namesToFind: string[]): Promise<ExpressionContainer | undefined> {
